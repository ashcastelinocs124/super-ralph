---
name: ralph-worker-lightweight
description: Super Ralph's lightweight implementation agent. Same test-first, production-grade role as ralph-worker, but dispatched for simple tasks where a smaller model is sufficient.
model: sonnet
---
